 ...
 * anything you would like so be creative (and school appropriate). Artwork must also
 * have a caption describing what it's depicting.  
 * 
...
public class ASCIIArt {
	...
	public static void drawSun() {
        ...
        sunUpperCorner(); 
        sunEyebrows(); 
        sunUpperCorner(); newLine();
        System.out.println("                            __|  ^ d ^   |__");
        System.out.println("                              |  ) v (   |");
        sunSpacing();
        sunLowerCorner();
        System.out.print("________");
        sunLowerCorner(); newLine();
        System.out.println("                                !   !   \\");
        System.out.println("                                '   !    `");
	}
	public static void drawForeground() {
		...
		System.out.print("         ");
		tree5LeafCluster(); newLine();
		System.out.print("     ");
		tree5LeafCluster(); space();
		tree3LeafCluster(); space();
		tree4LeafCluster(); newLine();
		space(); space();
		tree3LeafCluster(); space();
		tree4LeafCluster(); space();
		System.out.print("___  ");
		tree3LeafCluster(); space();
		tree4LeafCluster(); newLine();
		space();
		tree3LeafCluster(); space();
		tree3LeafCluster(); space(); space();
		treeApple(); space();
		tree4LeafCluster(); space();
		tree3LeafCluster(); space();
		tree4LeafCluster(); newLine();
		...
		tree3LeafCluster(); newLine();
		space();
		tree4LeafCluster();
		System.out.print("  __- _/ ");
		treeApple();
		System.out.print("# /");
		tree2LeafCluster(); space();
		treeApple(); space();
		tree4LeafCluster(); newLine();
		space(); space(); space();
		tree4LeafCluster(); space();
